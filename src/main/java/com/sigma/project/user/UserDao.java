...
public class UserDao {
  ...
  public synchronized void create(Connection conn, User valueObject) throws SQLException {
    ...
    try {
      sql = "INSERT INTO User ( user_id, user_name, password, "
            + "remarks, status, created_on, "
            + "created_by, edited_on, edited_by) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?) ";
      stmt = conn.prepareStatement(sql);

      stmt.setInt(1, valueObject.getUserId());
      stmt.setString(2, valueObject.getUserName());
      stmt.setString(3, valueObject.getPassword());
      stmt.setString(4, valueObject.getRemarks());
      stmt.setString(5, valueObject.getStatus());
      stmt.setDate(6, valueObject.getCreatedOn());
      stmt.setString(7, valueObject.getCreatedBy());
      stmt.setDate(8, valueObject.getEditedOn());
      stmt.setString(9, valueObject.getEditedBy());
  ...
  public void save(Connection conn, User valueObject)
    ...
    String sql = "UPDATE User SET user_name = ?, password = ?, remarks = ?, "
                 + "status = ?, created_on = ?, created_by = ?, "
                 + "edited_on = ?, edited_by = ? WHERE (user_id = ? ) ";
    PreparedStatement stmt = null;
    ...
    try {
      ...
      stmt.setString(3, valueObject.getRemarks());
      stmt.setString(4, valueObject.getStatus());
      stmt.setDate(5, valueObject.getCreatedOn());
      stmt.setString(6, valueObject.getCreatedBy());
      stmt.setDate(7, valueObject.getEditedOn());
      stmt.setString(8, valueObject.getEditedBy());

      stmt.setInt(9, valueObject.getUserId());
  ...
  public List searchMatching(Connection conn, User valueObject) throws SQLException {
    ...
    if (valueObject.getUserId() != 0) {
      ...
      sql.append("AND user_id = ").append(valueObject.getUserId()).append(" ");
    }
  ...
  protected void singleQuery(Connection conn, PreparedStatement stmt, User valueObject)
    ...
    try {
      ...
      if (result.next()) {
        ...
        valueObject.setUserId(result.getInt("user_id"));
        ...
        valueObject.setCreatedOn(result.getDate("created_on"));
        valueObject.setCreatedBy(result.getString("created_by"));
        valueObject.setEditedOn(result.getDate("edited_on"));
  ...
  protected List listQuery(Connection conn, PreparedStatement stmt) throws SQLException {
    ...
    try {
      ...
      while (result.next()) {
        ...
        temp.setCreatedOn(result.getDate("created_on"));
        temp.setCreatedBy(result.getString("created_by"));
        temp.setEditedOn(result.getDate("edited_on"));
